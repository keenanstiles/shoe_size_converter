...
# Updated dropdown menus
    ...
    def temp_convert(self):
        ...
        if self.from_units.get() == "US Men's":
            if self.to_units.get() == "EURO Women's":
                answer = (to_convert - 32) * 5 / 9 + 2.16667
                from_to = "{} US Men's{} is {} EURO Women's{}"

            elif self.to_units.get() == "US Women's":
                answer = to_convert - 1.5
                from_to = "{} US Men's{} is {} US Women's{}"

            elif self.to_units.get() == "EURO Men's":
                answer = (to_convert - 32) * 5 / 9 + 1.5
                from_to = "{} US Men's{} is {} EURO Men's{}"

        elif self.from_units.get() == "US Women's":
            if self.to_units.get() == "EURO Women's":
                answer = (to_convert - 30.5) * 5 / 9 + 2.16667
                from_to = "{} US Women's{} is {} EURO Women's{}"

            elif self.to_units.get() == "US Men's":
                answer = to_convert + 1.5
                from_to = "{} US Women's{} is {} US Men's{}"

            elif self.to_units.get() == "EURO Men's":
                answer = (to_convert - 30.5) * 5 / 9 + 1.5
                from_to = "{} US Women's{} is {} EURO Men's{}"

        elif self.from_units.get() == "EURO Men's":
            if self.to_units.get() == "EURO Women's":
                answer = to_convert - 1.5
                from_to = "{} EURO Men's{} is {} EURO Women's{}"

            elif self.to_units.get() == "US Men's":
                answer = (to_convert - 28.5) * 9 / 5 + 32
                from_to = "{} EURO Men's{} is {} US Men's{}"

            elif self.to_units.get() == "US Women's":
                answer = (to_convert - 28.5) * 9 / 5 + 1.5
                from_to = "{} EURO Men's{} is {} US Women's{}"

        elif self.from_units.get() == "EURO Women's":
            if self.to_units.get() == "EURO Men's":
                answer = to_convert + 1.5
                from_to = "{} EURO Women's{} is {} EURO Men's{}"

            elif self.to_units.get() == "US Men's":
                answer = (to_convert - 28.5) * 9 / 5 + 32 - 1.5
                from_to = "{} EURO Women's{} is {} US Men's{}"

            elif self.to_units.get() == "US Women's":
                answer = (to_convert - 28.5) * 9 / 5 + 1.5
                from_to = "{} EURO Women's{} is {} US Women's{}"
