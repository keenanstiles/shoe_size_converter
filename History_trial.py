...
from tkinter import messagebox, IntVar, StringVar, Toplevel, Frame, Label, Entry, Button
import re
...
class Partner:
    ...
    def to_history_button(self, state):
        pass
...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        self.all_calcs_label = Label(self.history_frame,
                                     text= "calculation {1}" "calculation {2}",
...
# Create a HistoryExport object

history_export = HistoryExport(partner, [])
