...
class Converter:
    ...
    def __init__(self):
        ...
        self.from_units = self.from_dropdown['values'].get
        ...
        self.convert_button = Button(self.temp_frame,
                                     ...
                                     font=("Arial", "12", "bold"),
                                     width=12,
                                     command=self.temp_convert(self.from_units))
    ...
    def convert_size(self, from_units, to_units, sizing_var, to_convert):
        ...
        found_conversion_rate = self.conversion_rates.get().get
