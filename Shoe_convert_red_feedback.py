    ...
    def check_shoe(self, min_value):
        ...
        try:
            ...
            if response < min_value:
                ...
                #self.output_label = Label(self.shoe_frame, text="", fg="#228b22")
                #self.var_feedback.set("Please enter a number greater than {}".format(min_value))
                self.output_label = Label(self.shoe_frame,
                                          text=f"Please enter a number greater than {min_value}", fg="#9C0000")
                #self.output_label = Label(self.shoe_frame, text="", fg="#228b22")

                self.var_feedback.Label(fg="#9C0000")
                return None
            else:
                self.var_has_error.set("no")
                # return number to be
